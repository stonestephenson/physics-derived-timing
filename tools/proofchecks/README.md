...
|---|---|---|---|
| `lemma1_check.py` | PROOF_DRAFT §1 (occupancy Lemma 1) | `ALL LEMMA-1 CHECKS PASS`: 17,176-case brute force (exhaustive 1-arc incl. wrapped + seeded multi-arc), all 3 profiles' geometry, all 9 committed `occupancy_sweep.csv` rows replicated exactly, inflated-arc Occ⁺ coupling table | ~2 min |
